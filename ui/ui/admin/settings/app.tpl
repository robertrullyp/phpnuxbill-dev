...
<div id="collapseSecurity" class="panel-collapse collapse" role="tabpanel">
  <div class="panel-body">
    ...
    <!-- CSRF (add heading like Turnstile) -->
    <hr class="clearfix">
    ...
    <!-- Cloudflare Turnstile (inside Security tab) -->
    <hr class="clearfix">
    ...
    <div class="form-group">
      ...
      <div class="col-md-5">
        <input type="password" class="form-control" name="turnstile_secret_key" value=""
               placeholder="•••••••• (Leave blank to keep unchanged)" autocomplete="new-password">
        <span class="help-block">{Lang::T('Leave this field empty to keep the current Secret Key unchanged')}</span>
      </div>
...
<!-- Tiny UX helpers: no change to original logic, only enhancements -->
<script>
  (function ($) {
